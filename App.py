...
if __name__ == "__main__":
    try:
        ...
        parser.add_argument("-gameid", help="Game ID", default="e40280a0")  # 游戏ID
        ...
        if flag == "y":
            ...
            if device == "":
                ...
                devicetype = "Android"
                if ip == "":
                    ip = StaticData.GetDeviceIP(device, adbPath)

                udriver = MaRunner.MatoryConnect(device, ip, port=2666, timeout=60)
